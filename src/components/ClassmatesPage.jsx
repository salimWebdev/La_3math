  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="text-center mb-16">
        ...
        <p className="font-script text-vintage-gold text-xl mb-2 opacity-80 wind-drift">The People Who</p>
          ...
          return (
            ...
            >
              ...
              <div className="ornate-frame rounded-sm overflow-hidden">
                <div className={`flex flex-col ${isEven ? 'md:flex-row' : 'md:flex-row-reverse'} items-stretch min-h-[400px]`}>

                  {/* Photo + Name side */}
                  <div className={`md:w-[400px] flex-shrink-0 flex flex-col items-center justify-center p-6 bg-gradient-to-b from-parchment/50 to-cream/50`}>
                    {/* Gold frame photo */}
                    <div className="relative w-full max-w-[340px] mb-5">
                      <img
                        src="/assets/photos/gold-frame.png"
                        alt="Frame"
                    ...
                    {/* Name */}
                    <h3 className="font-serif text-2xl md:text-3xl text-sepia embossed-text text-center leading-tight">
                      {classmate.name}
                    </h3>

                    {/* Nickname */}
                    {classmate.nickname && (
                      <p className="font-script text-vintage-gold text-base italic mt-1 opacity-80 text-center">
                        "{classmate.nickname}"
                      </p>
                    )}
                  </div>
                  ...
                  <div className="flex-1 flex items-center justify-center p-8 md:p-12 relative">
                    ...
                    <div className="max-w-lg">
                      ...
                      <div className="flex items-center gap-2 mb-5">
                        <div className="w-8 h-px bg-vintage-gold/40" />
                        <span className="text-vintage-gold text-xs">◆</span>
                        <div className="w-12 h-px bg-vintage-gold/40" />
                      </div>

                      <p className="font-body text-warm-brown leading-relaxed text-lg md:text-xl">
