  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="text-center mb-16">
        ...
        <p className="font-script text-vintage-gold text-xl mb-2 opacity-80 wind-drift">Our Journey of</p>
      ...
      <div className="mt-20 max-w-2xl mx-auto">
        ...
        <div className="double-frame rounded-sm p-3">
          {/* Inner ornate border */}
          <div className="ornate-frame rounded-sm p-2">
            {/* Certificate content */}
            <div className="bg-gradient-to-br from-cream via-ivory to-cream rounded-sm p-8 md:p-12 text-center relative">
              {/* Corner flourishes */}
              <div className="absolute top-4 left-4 text-3xl text-vintage-gold opacity-40">❧</div>
              <div className="absolute top-4 right-4 text-3xl text-vintage-gold opacity-40 rotate-90">❧</div>
              <div className="absolute bottom-4 left-4 text-3xl text-vintage-gold opacity-40 -rotate-90">❧</div>
              <div className="absolute bottom-4 right-4 text-3xl text-vintage-gold opacity-40 rotate-180">❧</div>

              {/* Top flourish */}
              <div className="flex justify-center mb-4">
                <span className="flourish text-2xl opacity-60">~ ~ ~</span>
              </div>

              {/* Seal */}
              <div className="mb-6">
                <div className="wax-seal w-20 h-20 mx-auto rounded-full flex items-center justify-center">
                  <span className="text-3xl filter brightness-125">🏫</span>
                </div>
              </div>

              {/* Title */}
              <h3 className="font-serif text-2xl md:text-3xl text-sepia mb-2 embossed-text">
                Certificate of Achievement
              </h3>

              <p className="font-script text-vintage-gold text-lg mb-6 opacity-80">
              ...
              {/* Certificate body */}
              <p className="font-body text-warm-brown leading-relaxed text-lg italic max-w-lg mx-auto mb-8">
              ...
              {/* Signatures */}
              <div className="flex justify-center items-end gap-12 md:gap-16 mt-8">
                <div className="text-center">
                  <div className="w-32 h-px bg-sepia/60 mb-3 mx-auto" />
                  <p className="font-script text-sm text-sepia">Class Teacher</p>
                </div>
                <div className="text-center">
                  <div className="w-32 h-px bg-sepia/60 mb-3 mx-auto" />
                  <p className="font-script text-sm text-sepia">Principal</p>
                </div>
              </div>

              {/* Bottom flourish */}
              <div className="flex justify-center mt-8">
                <span className="flourish text-xl opacity-40">~ ~ ~</span>
              </div>
            </div>
          </div>
        </div>
